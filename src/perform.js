...
export function perform2() {
    ...
    if (s1 === 1 && s2 === 3) {
        ...
        if (i > 5 || isNaN(i)) {
            ...
            document.f1.V.value = v;
            document.f1.vth1.value = document.f1.V.value
        ...
        alert("Please select S1 to Position-1 (Supply) and S2 to Open Position.")
    }
}
